...
class SettingsRepository implements ISettingsRepository {
  ...
  EnergyUnit get energyUnit =>
      _box.get("energyUnit") as EnergyUnit? ?? EnergyUnit.kilojoules;
  @override
  ...
  set energyTarget(double target) =>
      _box.put("energyTarget", target.roundToPrecision(2));

  @override
  WeightUnit get weightUnit =>
      _box.get("weightUnit") as WeightUnit? ?? WeightUnit.kilograms;
  @override
  ...
  set weightTarget(double target) =>
      _box.put("weightTarget", target.roundToPrecision(2));

  @override
  ThemeMode get themeMode =>
      _box.get("themeMode") as ThemeMode? ?? ThemeMode.system;
  @override
